...
namespace WPrime64
{
	public class StringTools
	{
		...
		public static string GetString(Color color)
		{
			...
			return ZPad(Convert.ToString(value, 16), 6);
		}

		public static bool IsLocalDiskFullPath(string path)
		{
		...
		public static string[] Prime64StdoutFilter(string[] lines)
		{
			...
			foreach (string line in lines)
				if (line.StartsWith(OUT_PFX))
					dest.Add(line.Substring(OUT_PFX.Length));
